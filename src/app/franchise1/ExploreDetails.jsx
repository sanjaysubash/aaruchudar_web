...
import { 
  ...
  Network, Cpu, Zap, TrendingUp2, Scale,
  Crown, Key, LineChart, Coins, Users3, Building2,
  Sparkles, Award2, CalendarDays, BadgeCheck
} from 'lucide-react';
  ...
  const modalContents = {
    ...
    'global-expansion': {
      ...
      stats: [
        ...
        { label: "Success Rate", value: "91%", icon: Award2 }
      ],
      sections: [
        {
